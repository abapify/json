...
| **XCO_CP_JSON** (`xco_cp_json`)                              | ✅ Modern, officially supported API for Cloud <br> ✅ Supports automatic serialization/deserialization <br> ✅ Type-safe operations <br> ❌ Not available in older on-premise systems  <br> ❌ Enormously slow <br> ❌ Dumps on data refs                                                                           |
